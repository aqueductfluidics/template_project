...
from devices.aqueduct.pp6.constants import *
...
class PP6(devices.base.obj.Device):
    ...
    def start(
        ...
        For each of the 6 pump inputs, pass a :class:`PumpCommand`, a dictionary (specified keys below), or None.
        ...
        .. code-block:: python
            ...
            command = PP6SIM.make_command(mode = PP6SIM.continuous, direction = PP6SIM.infuse,
                                           rate_value = 1.0, rate_units = PP12SIM.ml_min)

            PP6SIM.pump(pump0=command, pump2=command)
        ...
        .. code-block:: python
            ...
            command = PP6SIM.make_command(mode = PP6SIM.finite, direction = PP6SIM.withdraw,
                                           rate_value = 1.0, rate_units = PP6SIM.ml_min,
                                           finite_value = 5.0, finite_units = PP6SIM.ml)

            PP6SIM.pump(pump1=command)
        ...
        .. code-block:: python
            ...
            dict_command = {
                'mode': PP6SIM.finite,
                'direction': PP6SIM.infuse,
                'rate_value': 3.5,
                'rate_units': PP6SIM.ul_min
            }

            PP6SIM.pump(pump1=dict_command)
